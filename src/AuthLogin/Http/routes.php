...
Route::group(['prefix' => config('kregel.auth-login.prefix'), 'as' => 'auth-login::', 'namespace' => 'Auth'], function () {
    ...
    Route::group(['middleware' => ['web', 'auth']], function() {
        ...
        Route::get('security', ['as' => 'security', 'uses' => 'SecurityController@getSecurity']);
        Route::put('security', ['as' => 'update-security', 'uses' => 'SecurityController@putSecurity']);

        Route::get('profile/{id}/{name?}', ['as' => 'profile', 'uses' => 'ProfileController@profile']);
