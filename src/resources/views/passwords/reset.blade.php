        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('auth-login::post-reset') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ !empty($errors) && $errors->has('password_confirmation') ? ' has-error' : '' }}">
